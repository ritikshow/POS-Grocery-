...
@Component({
  selector: 'app-voided-order',
  templateUrl: './voided-order.component.html',
  styleUrls: ['./voided-order.component.css']
})
export class VoidedOrderComponent implements OnInit {
  tableListRecord: any = [];
  isDataLoaded = false;
  ...
  getAllOrders() {
    ...
    this.posDataService.GetAllVoidedOrder(this.outletId, "Dine-in").subscribe((res: any) => {
