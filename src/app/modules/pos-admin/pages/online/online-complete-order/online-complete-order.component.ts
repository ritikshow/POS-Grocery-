...
@Component({
  selector: 'app-online-complete-order',
  templateUrl: './online-complete-order.component.html',
  styleUrls: ['./online-complete-order.component.css']
})
export class OnlineCompleteOrderComponent implements OnInit {
  tableListRecord: any = [];
  isDataLoaded = false;
